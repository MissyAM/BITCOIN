def sha256_algorithm(string_to_decode):
    ...
    s = ((hex(h0)[2:]),(hex(h1)[2:]),(hex(h2)[2:]),(hex(h3)[2:]),(hex(h4)[2:]),(hex(h5)[2:]),(hex(h6)[2:]),(hex(h7)[2:]))

    h_final = ''.join(s)
    return h_final      

print(sha256_algorithm("1ghdjtyuaghdkiyuinhjyuolkhgfddssioplkjlllllllllmmmmmmm"))
